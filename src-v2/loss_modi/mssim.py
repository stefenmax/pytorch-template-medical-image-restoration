...
def ssim(X, Y, win_size=11, win_sigma=10, win=None, data_range=255, size_average=True, full=False):
...
class MSSIM(nn.Module):
    def __init__(self, win_size=5, win_sigma=1.5, data_range=255, size_average=True, channel=3, weights=None):
